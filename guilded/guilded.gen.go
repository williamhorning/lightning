...
type guildedSocketEventEnvelope struct {
	...
	Op guildedSocketEventEnvelopeOp `json:"op"`
	S  *string                      `json:"s,omitempty"`
	T  *string                      `json:"t,omitempty"`
}

const (
	guildedSocketOPSuccess guildedSocketEventEnvelopeOp = 0
	guildedSocketOPWelcome guildedSocketEventEnvelopeOp = 1
	guildedSocketOPResume  guildedSocketEventEnvelopeOp = 2
	guildedSocketOPError   guildedSocketEventEnvelopeOp = 8
	guildedSocketOPPing    guildedSocketEventEnvelopeOp = 9
	guildedSocketOPPong    guildedSocketEventEnvelopeOp = 10
)

type guildedSocketEventEnvelopeOp int
